    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="overflow-y-auto custom-scrollbar px-2 py-3 max-h-[calc(90vh-60px)]" 
               style={{
                 scrollbarWidth: 'thin',
            ...
            <div className="grid gap-3">
              ...
              {/* Moved the buttons inside the scrollable area with margin-top */}
              <div className="flex justify-end gap-2 pt-3 border-t border-[#3BADE5]/10 mt-4">
                <button
      ...
      {showConfirmClose && (
        <Dialog open={showConfirmClose} onOpenChange={handleCancelClose}>
          <DialogContent className="max-w-sm bg-[#0B1623] border border-[#3BADE5]/20 p-0">
            <DialogHeader className="px-2 pt-3 pb-3 border-b border-[#3BADE5]/20">
            ...
            <div className="flex justify-end gap-2 pt-2 pb-3 px-2 border-t border-[#3BADE5]/20">
              <button
