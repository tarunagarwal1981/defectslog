...
const DefectDialog = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-[90vw] md:max-w-[600px] h-[90vh] max-h-[900px] bg-[#0B1623] overflow-hidden flex flex-col p-0 rounded-lg border border-[#3BADE5]/20 shadow-2xl relative">
        <DialogHeader className="flex-shrink-0 px-6 py-4 border-b border-[#3BADE5]/20 bg-[#132337]">
        ...
        {/* Fixed Footer */}
        <div className="flex justify-end gap-3 p-6 border-t border-[#3BADE5]/20 mt-auto bg-[#132337]">
          <button
            onClick={onClose}
            disabled={saving}
