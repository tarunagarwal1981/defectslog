      ...
      >
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div 
              className="overflow-y-auto flex-grow px-4 py-4"
              style={{
                scrollbarWidth: 'thin',
            ...
            <div className="border-t border-[#3BADE5]/10 px-4 py-3 mt-auto bg-[#0B1623] flex justify-end items-center gap-3">
              <button
        ...
        <Dialog open={showConfirmClose} onOpenChange={handleCancelClose}>
          <DialogContent className="max-w-sm bg-[#0B1623] border border-[#3BADE5]/20 p-0">
            <div className="flex flex-col">
              ...
              <div className="flex justify-end gap-3 pt-2 pb-3 px-4 border-t border-[#3BADE5]/20 mt-auto">
                <button
